  	...
  	background-color:rgba(158, 158, 158, 0.25);}
        ...
        <fieldset>
            ...
            <table>
              ...
              <tr>
                <td class="bajos"><input type="text" id="placa" name="placa" value="<?php echo $auto['placas']?>" readonly/></td>
              ...
              <tr>
                  <td colspan="4" align="right"><a href="index.php?ctl=editAuto&id=<?php echo $auto['automovil_id']?>">editar</a></td>
                </tr>
            </table>
        </fieldset>
