...
table{
    ...
    <form action="index.php?ctl=editAuto" method="post">
        <fieldset>
            ...
            <table>
              ...
              <tr>
                <td class="bajos"><input type="text" id="placa" name="placa" value="<?php echo $auto['placas'];?>" /></td>
              ...
              <tr>
                <td colspan="7" align="right"><input type="submit" value="guardar" name="insertar" /></td>
              </tr>
            </table>
        </fieldset>
    </form>
