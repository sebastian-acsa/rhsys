 ...
 <div style="float:center">
     <table border="1" width="720px">
         ...
         <tr><!--encabezados-->
             ...
             <th width="450" class="centrados" style="background-color: rgba(158, 158, 158, 0.76);">&nbsp;&nbsp;&nbsp;Puesto</th>
             
         </tr>
         <tr><td  class="centrados"><?php echo $params['diseno'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td  class="centrados"><?php echo $params['presupuestos'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['planeacion'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td   class="centrados"><?php echo $params['admin_proy'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['calidad'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['construccion'][1]['departamento_name'];?></td></tr>
  ...
  <div style="float:center">
    <table border="1" width="720px">
        <tr><!--encabezados-->
         ...
         <tr><td   class="centrados"><?php echo $params['direccion'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['relaciones'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['comercial'][0]['departamento_name'];?></td></tr>
        ...
        <?php if(isset($params['finanzas'][0]['departamento_name'])&& !empty($params['finanzas'][0]['departamento_name'])){?>
         ...
         <tr><td   class="centrados"><?php echo $params['finanzas'][0]['departamento_name'];?></td></tr>
     ...
     <?php }?>
        ...
        <tr><td   class="centrados"><?php echo $params['contabilidad'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados" ><?php echo $params['control'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td   class="centrados"><?php echo $params['contraloria'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['abastecimiento'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td   class="centrados"><?php echo $params['rh'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['juridico'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td   class="centrados"><?php echo $params['sistemas'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td   class="centrados"><?php echo $params['limpieza'][0]['departamento_name'];?></td></tr>
