...
<h2 class="area"><strong>AREA OPERATIVA</strong>&nbsp; <a href="./app/assets/Monitor_empleados.php" target="_blank"><img src="./img/xlsbtn.jpg" width="25px" height="25px"></a></h2>
    <div style="float:center">
        <table border="1" width="840px">
            ...
            <tr><!--encabezados-->
                <th width="350px" class="centrados" style="background-color: rgba(158, 158, 158, 0.76);">&nbsp;&nbsp;&nbsp;Nombre</th>
                <th width="350px" class="centrados" style="background-color: rgba(158, 158, 158, 0.76);">&nbsp;&nbsp;&nbsp;Puesto</th>
                <th width="130px" class="centrados" style="background-color: rgba(158, 158, 158, 0.76);">&nbsp;&nbsp;&nbsp;Sueldo Actual</th>
            </tr>
            <tr><td colspan="3" class="centrados"><?php echo $params['diseno'][0]['departamento_name'];?></td></tr>
            ...
            <td class="derecha">&nbsp;&nbsp;&nbsp;<?php echo "$".number_format($empleado['su_actual'],2,".",",") ?></td>
             <!--datos a mostrar-->
            </tr>
            <?php endforeach; ?>

            <tr><td colspan="3" class="centrados"><?php echo $params['presupuestos'][0]['departamento_name'];?></td></tr>
            ...
            <tr><td colspan="3" class="centrados"><?php echo $params['planeacion'][0]['departamento_name'];?></td></tr>
            ...
            <tr><td colspan="3" class="centrados"><?php echo $params['admin_proy'][0]['departamento_name'];?></td></tr>
            ...
            <tr><td colspan="3" class="centrados"><?php echo $params['calidad'][0]['departamento_name'];?></td></tr>
            ...
            <tr><td colspan="3" class="centrados"><?php echo $params['construccion'][1]['departamento_name'];?></td></tr>
  ...
  <div style="float:center">
    <table border="1" width="840px">
        <tr><!--encabezados-->
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['direccion'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['relaciones'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['comercial'][0]['departamento_name'];?></td></tr>
        ...
        <?php if(isset($params['finanzas'][0]['departamento_name'])&& !empty($params['finanzas'][0]['departamento_name'])){?>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['finanzas'][0]['departamento_name'];?></td></tr>
     ...
     <?php }?>
        ...
        <tr><td colspan="3" class="centrados"><?php echo $params['contabilidad'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados" ><?php echo $params['control'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td colspan="3" class="centrados"><?php echo $params['contraloria'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['abastecimiento'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td colspan="3" class="centrados"><?php echo $params['rh'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['juridico'][0]['departamento_name'];?></td></tr>
        ...
        <tr><td colspan="3" class="centrados"><?php echo $params['sistemas'][0]['departamento_name'];?></td></tr>
         ...
         <tr><td colspan="3" class="centrados"><?php echo $params['limpieza'][0]['departamento_name'];?></td></tr>
